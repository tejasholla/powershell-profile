...
function qr {
    ...
    try {
        ...
        $FileFormat = "jpg"
        $IsLinux = $PSVersionTable.PSPlatform -eq 'Unix'
        ...
        $NewFile = Join-Path $PathToPics "QR_code.jpg"
        
        $WebClient = New-Object System.Net.WebClient
        $Url = "http://api.qrserver.com/v1/create-qr-code/?data=$Text&ecc=$ECC&size=$ImageSize&qzone=$QuietZone&color=$ForegroundColor&bgcolor=$BackgroundColor&format=$FileFormat"
