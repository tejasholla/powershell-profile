...
function search {
    ...
    .EXAMPLE
    "google.com" | search -SearchEngine Bing -Verbose -DetailedOutput
    search -Text "google.com" -SearchEngine Google -NoBrowser -Verbose -DetailedOutput
    search -Text "google.com" -SearchEngine Yahoo -Verbose -DetailedOutput
